(function (module) {
    mifosX.controllers = _.extend(module, {
        CreateShgGroupController: function (scope, resourceFactory, location, dateFilter, routeParams) {
    ...
    mifosX.ng.application.controller('CreateShgGroupController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', '$routeParams', mifosX.controllers.CreateShgGroupController]).run(function ($log) {
        $log.info("CreateShgGroupController initialized");
    });
}(mifosX.controllers || {}));