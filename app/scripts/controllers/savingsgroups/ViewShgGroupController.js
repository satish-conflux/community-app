(function (module) {
    mifosX.controllers = _.extend(module, {
        ViewShgGroupController: function (scope, routeParams, route, location, resourceFactory, dateFilter, $modal) {
            if(routeParams.type){
    ...
    mifosX.ng.application.controller('ViewShgGroupController', ['$scope', '$routeParams', '$route', '$location', 'ResourceFactory', 'dateFilter', '$modal', mifosX.controllers.ViewShgGroupController]).run(function ($log) {
        $log.info("ViewShgGroupController initialized");
    });
}(mifosX.controllers || {}));